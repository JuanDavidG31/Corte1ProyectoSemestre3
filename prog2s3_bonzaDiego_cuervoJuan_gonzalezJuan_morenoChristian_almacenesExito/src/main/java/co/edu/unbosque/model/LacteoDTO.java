...
/**
 * Data Transfer Object (DTO) para representar un producto lácteo.
 * Contiene información relevante para la transferencia de datos entre capas del sistema.
 */
public class LacteoDTO {
	private int id;
	private String code;
	private String name;
	...
	/**
	 * Constructor vacio de LacteoDTO.
	 */
	public LacteoDTO() {
		// TODO Auto-generated constructor stub
	}
	/**
	 * Constructor con parámetros para inicializar un objeto LacteoDTO.
	 *
	 ...
	 */
	public LacteoDTO(int id, String code, String name, String description, String image, double price, String category,
	...
	/**
	 * Obtiene la URL o el nombre del archivo de imagen del producto.
	 *
	...
	/**
	 * Establece la URL o el nombre del archivo de imagen del producto.
	 *
	 ...
	 *
	 * @return Cantidad del producto en inventario.
	 */
	...
	/**
	 * Compara si dos objetos LacteoDTO son iguales basándose en su código.
	 *
	...
	/**
	 * Calcula el código hash del objeto LacteoDTO basándose en su código.
	 *
	...
	/**
	 * Devuelve una representación en cadena del objeto LacteoDTO.
	 *
